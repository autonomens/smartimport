...
def train(display_confusion_matrix=False, save_model=True):
    ...
    model_module_path, _, clazz = model_path.rpartition('.') # Get module and class to load
    ...
    print(f"Use {model_path} module for training with str2feature algo {settings.STR2FEATURES_CONF['algo']}")
